...
public:
	...
	int	ts_index;							// index into the team select and Loadout manager (or -1 if not in one of those arrays)
...
extern std::array<SCP_vector<int>, MAX_TVT_TEAMS> TVT_wings[MAX_TVT_WINGS];

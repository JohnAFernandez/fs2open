...
public:
	...
	SCP_vector<int> kills;		// only valid kills (i.e. not on friendlies).
	...
	int m_score;
	SCP_vector<int> m_kills;		// this will represent all kills in the mission (bonehead or not)
	SCP_vector<int> m_okKills;	// this will be only the "valid" kills the player made
